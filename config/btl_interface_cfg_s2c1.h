 ...
 *
 ******************************************************************************/
#ifndef BTL_INTERFACE_CFG_S2C1_H
#define BTL_INTERFACE_CFG_S2C1_H
...
#define BOOTLOADER_PPUSATD0_HFXO0 0
...
// <q> USART1
// <i> Update secure access state of USART1 before calling into bootloader
#define BOOTLOADER_PPUSATD0_USART1 0

// <q> USART2
// <i> Update secure access state of USART2 before calling into bootloader
#define BOOTLOADER_PPUSATD0_USART2 0
...
// <q> LVGD
// <i> Update secure access state of LVGD before calling into bootloader
#define BOOTLOADER_PPUSATD0_LVGD 0
...
// <q> IFADCDEBUG
// <i> Update secure access state of IFADCDEBUG before calling into bootloader
#define BOOTLOADER_PPUSATD0_IFADCDEBUG 0
...
// <q> RTCC
// <i> Update secure access state of RTCC before calling into bootloader
#define BOOTLOADER_PPUSATD0_RTCC 0
...
// <q> HFRCOEM23
// <i> Update secure access state of HFRCOEM23 before calling into bootloader
#define BOOTLOADER_PPUSATD1_HFRCOEM23 0
...
// <q> BUFC
// <i> Update secure access state of BUFC before calling into bootloader
#define BOOTLOADER_PPUSATD1_BUFC 0
